...
for(i in 1:n_files){
  ...
  # calc nucleotide diversity (over sliding window by default)
  nucdiv_windowed <- calc_nuc_div(ms_binary, abs_positions, GENOME_LENGTH, seqLen = 100, centerSpacing = 200)
...
# 1 is window size 50, 2 is window size 100
